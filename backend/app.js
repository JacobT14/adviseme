//jshint esversion:6
//jshint esversion:6
const {answerPrompt} = require( './sessions/prompts/answer-prompt')
const { apiWrapper } =  require('./api-wrapper')


const express = require('express')
const http = require('http')
const {Session, User, mongoose} = require('./models/index')
const app = express()
...
app.post('/sessions/:sessionId/prompts/:promptId/answer-prompt', async function (
  ...
  const { user: username } = req.auth
  const { sessionId, promptId } = req.params
  return apiWrapper(answerPrompt, req, res, { response, username, sessionId, promptId, io })
})
